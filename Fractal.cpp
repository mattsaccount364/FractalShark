...
template<class T, class SubType, Fractal::BenchmarkMode BenchmarkState>
...
template<class T, class SubType, bool Periodicity, Fractal::BenchmarkMode BenchmarkState, Fractal::CalcBad Bad, Fractal::ReuseMode Reuse>
void Fractal::AddPerturbationReferencePointST(HighPrecision initX, HighPrecision initY) {
    ...
    if constexpr (Reuse == Fractal::ReuseMode::SaveForReuse) {
        InitReused(results);
    }
...
template<class T, class SubType, bool Periodicity, Fractal::BenchmarkMode BenchmarkState, Fractal::CalcBad Bad>
...
HighPrecision Fractal::Benchmark(size_t numIters, size_t& milliseconds)
{
    ...
    if (RequiresReferencePoints()) {
        AddPerturbationReferencePoint<double, double, BenchmarkMode::Disable>();
    }
...
HighPrecision Fractal::BenchmarkReferencePoint(size_t numIters, size_t& milliseconds) {
    ...
    AddPerturbationReferencePoint<T, SubType, BenchmarkMode::Enable>();
