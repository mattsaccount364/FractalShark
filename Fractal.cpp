...
void Fractal::AutoZoom() {
    HighPrecision newMinX = m_MinX;
    HighPrecision newMinY = m_MinY;
    HighPrecision newMaxX = m_MaxX;
    HighPrecision newMaxY = m_MaxY;
    const HighPrecision Four = 4;
    ...
    for (;;) {
        ...
        for (auto y = antiRect.top; y < antiRect.bottom; y++) {
            for (auto x = antiRect.left; x < antiRect.right; x++) {
                ...
                if (m_CurIters.m_ItersArray[y][x] >= GetNumIterations()) {
                    numAtMax++;
                }
            }
        }
...
void Fractal::View(size_t view)
{
    ...
    case 8:
        ...
        minX = HighPrecision{ "-1." };
        minY = HighPrecision{ "0." };
        maxX = HighPrecision{ "-1." };
        maxY = HighPrecision{ "0." };
    ...
    case 13:
        // fun
        minX = HighPrecision{ "-1." };
        minY = HighPrecision{ "0." };
        maxX = HighPrecision{ "-1." };
        maxY = HighPrecision{ "0." };
        SetNumIterations(21233664);
        break;
...
void Fractal::AddPerturbationReferencePointST(HighPrecision initX, HighPrecision initY) {
    ...
    for (i = 0; i < m_NumIterations; i++)
    {
        ...
        if constexpr (Periodicity) {
            HighPrecision n1 = max(boost::multiprecision::abs(dzdcX), boost::multiprecision::abs(dzdcY));
            HighPrecision n2 = max(boost::multiprecision::abs(zx), boost::multiprecision::abs(zy));
            if (results->maxRadius * n1 * HighPrecision{ 2 } > n2) {
            ...
            dzdcX = HighPrecision{ 2.0 } * zx * dzdcX - HighPrecision{ 2.0 } * zy * dzdcY + HighPrecision(1.0);
            dzdcY = HighPrecision{ 2.0 } * zx * dzdcY + HighPrecision{ 2.0 } * zy * dzdcXOrig;
        }
