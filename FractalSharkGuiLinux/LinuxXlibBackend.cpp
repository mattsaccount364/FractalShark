...
struct BackendData {
    ...
    FractalShark::LinuxClipboard *clipboard = nullptr;
...
KeySymToImGuiKey(KeySym ks)
{
    ...
    case XK_Return:
    case XK_KP_Enter: return ImGuiKey_Enter;
...
void
ImGui_ImplXlib_SetClipboardHelper(FractalShark::LinuxClipboard *clipboard)
{
...
ImGui_ImplXlib_ProcessEvent(const XEvent &ev)
{
    ...
    case ButtonRelease: {
        ...
        case Button2: io.AddMouseButtonEvent(2, down); break; // middle
        case Button3: io.AddMouseButtonEvent(1, down); break; // right
        case Button4: if (down) io.AddMouseWheelEvent(0.0f, 1.0f); break;
        case Button5: if (down) io.AddMouseWheelEvent(0.0f, -1.0f); break;
        case 6: if (down) io.AddMouseWheelEvent(-1.0f, 0.0f); break; // hwheel
