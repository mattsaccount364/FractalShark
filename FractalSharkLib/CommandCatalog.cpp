...
// via kAlgCmds; everything else is a 1:1 enum→method routing.
...
ExecuteCommand(FractalCommand cmd, ExecuteCommandHost &host)
{
    ...
    switch (cmd) {
        ...
        case FractalCommand::LaMultithreaded:
            host.OnLaMultithreaded();
            return;
        case FractalCommand::LaSinglethreaded:
            host.OnLaSinglethreaded();
            return;
