...
private:
    ...
    void BasicTestInternal(const wchar_t *dirName, size_t &testIndex, IterTypeEnum iterType);

    template <TestTypeEnum viewIndex>
    void BasicOneTest(auto algToTest,
                      size_t &testIndex,
                      const wchar_t *dirName,
                      const wchar_t *testPrefix,
                      IterTypeEnum iterType);

    static std::string GenFilename(size_t testIndex,
                                   size_t viewIndex,
    ...
    static std::wstring GenFilenameW(size_t testIndex,
                                     size_t viewIndex,
                                     RenderAlgorithm algToTest,
                                     int32_t compressionError,
                                     IterTypeEnum iterType,
    ...
    void ReferenceSaveLoad(Fractal &fractal,
                           const wchar_t *dirName,
                           size_t viewIndex,
                           size_t testIndex,
                           IterTypeEnum iterType,
