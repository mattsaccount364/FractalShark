...
void Fractal::View(size_t view)
{
    ...
    case 27:
        ...
        //    zoomFactor "1.89723873897916448306e+58"

        //    Additional details :
        //PeriodMaybeZero = 2461889665
        //    CompressedIters = 17502721
        //    UncompressedIters = 2461889665
        //    Compression ratio = 140.657539
        //    Compression error exp = 18
        ...
        SetCompressionErrorExp(19);
        SetIterType(IterTypeEnum::Bits64);
        SetNumIterations<IterTypeFull>(1'000'000'000'000);
        break;
