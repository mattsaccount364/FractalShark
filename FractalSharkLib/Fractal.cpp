...
#include "LargeCoords.h"
        ...
        case 31: {
            ...
            PointZoomBBConverter convert{
                HighPrecision{
                    "-1."},
                HighPrecision{
                    "-9.-03"},
            ...
            maxY = convert.GetMaxY();
            UsePalette(6);
            SetNumIterations<IterTypeFull>(69120000);
            ResetDimensions(MAXSIZE_T, MAXSIZE_T, 4);
            break;
        }
