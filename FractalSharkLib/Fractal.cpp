...
void Fractal::View(size_t view)
{
    ...
    case 1:
        // Limits of 4x64 GPU
        minX = HighPrecision{ "-0.8404214088337048307022478980842261057520384200145288005963690109600000613651841" };
        minY = HighPrecision{ "0.207796151965022888319822377392563051923055983218732734071065319803139628935995" };
        maxX = HighPrecision{ "-0.8404214088297048307022479087423671421535281918764566675830886443809053078732481" };
        maxY = HighPrecision{ "0.2077961519690228883198223667344220155215662113568048670843456863822343824279311" };
