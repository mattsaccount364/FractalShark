...
// the FractalShark namespace's menu factories (Sep, Item, Toggle, Radio,
...
static const Node menu[] = {
    ...
    FS_POPUP0(
        ...
        Sep(),
        Item(L"Autozoom Feature With Checkpoint Save (a)",
             FractalCommand::AutoZoomFeatureWithCheckpointSave),
        Item(L"Autozoom Feature Without Checkpoint Save (A)",
        ...
        FS_POPUP0(
            ...
            Item(L"Resume NR Refinement",
                 FractalCommand::FeatureFinderResume,
    ...
    FS_POPUP(
        ...
        FS_POPUP0(L"CPU-Only",
                  ...
                  Sep(),
                  Radio(L"1x64 CPU - Perturbation BLA",
                        FractalCommand::AlgCpu1x64PerturbBla,
                        RG::RenderAlgorithm),
                  Radio(L"HDRx32 CPU - Perturbation BLA",
                        FractalCommand::AlgCpu1x32PerturbBlaHdr,
                        RG::RenderAlgorithm),
                  Radio(L"HDRx64 CPU - Perturbation BLA",
                        FractalCommand::AlgCpu1x64PerturbBlaHdr,
                        RG::RenderAlgorithm),
                  Sep(),
        ...
        FS_POPUP0(
            ...
            FS_POPUP(L"Iteration Precision",
                     ...
                     Radio(L"1x (better quality)",
                           FractalCommand::IterationPrecision1x,
                           RG::IterationPrecision)),
        ...
        FS_POPUP0(L"Reference Compression",
    ...
    FS_POPUP(
        ...
        Radio(L"ST + Periodicity",
              FractalCommand::PerturbationSinglethreadPeriodicity,
              RG::PerturbationMode),
        Radio(L"MT2 + Periodicity",
              FractalCommand::PerturbationMultithread2Periodicity,
              RG::PerturbationMode),
    ...
    FS_POPUP0(L"Memory Management",
              Radio(L"Enable Auto-Save Orbit (delete when done, default)",
                    ...
                    RG::MemoryAutosave),
              Radio(L"Enable Auto-Save Orbit (keep files)",
                    FractalCommand::PerturbAutosaveOn,
                    RG::MemoryAutosave),
