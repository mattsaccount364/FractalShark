...
static const Node menu[] = {
    ...
    FS_POPUP0(
        ...
        Item(L"Autozoom Filament Tip (S)", IDM_AUTOZOOM_FILAMENT),
        Sep(),
        FS_POPUP0(L"Feature Finder",
                  ...
                  Item(L"Resume NR Refinement", IDM_FEATUREFINDER_RESUME, R::EnableIfNRCheckpointExists),
                  Item(L"Clear All Found Features (>)", IDM_FEATUREFINDER_CLEAR),
                  Sep(),
                  Radio(L"NR Inner Loop: GPU",
                        IDM_NR_INNERLOOP_GPU,
                        RG::NRInnerLoopBackend,
                        R::EnableIfGpuActive),
                  Radio(L"NR Inner Loop: CPU MT", IDM_NR_INNERLOOP_CPU, RG::NRInnerLoopBackend),
                  Radio(L"NR Inner Loop: CPU ST", IDM_NR_INNERLOOP_CPUST, RG::NRInnerLoopBackend))),
    ...
    FS_POPUP(
        ...
        FS_POPUP0(
            ...
            Radio(L"1x32 GPU", IDM_ALG_GPU_1_32, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"2x32 GPU", IDM_ALG_GPU_2_32, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"4x32 GPU", IDM_ALG_GPU_4_32, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"1x64 GPU", IDM_ALG_GPU_1_64, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"2x64 GPU", IDM_ALG_GPU_2_64, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"4x64 GPU", IDM_ALG_GPU_4_64, RG::RenderAlgorithm, R::EnableIfGpuActive),
            Radio(L"HDRx32 GPU", IDM_ALG_GPU_2X32_HDR, RG::RenderAlgorithm, R::EnableIfGpuActive)),
        ...
        FS_POPUP0(L"Perturbation Only",
                  Radio(L"1x32 GPU - Perturb only",
                        IDM_ALG_GPU_1_32_PERTURB_LAV2_PO,
                        RG::RenderAlgorithm,
                        R::EnableIfGpuActive),
                  Radio(L"2x32 GPU - Perturb only",
                        IDM_ALG_GPU_2_32_PERTURB_LAV2_PO,
                        RG::RenderAlgorithm,
                        R::EnableIfGpuActive),
                  Radio(L"1x64 GPU - Perturb only",
                        IDM_ALG_GPU_1_64_PERTURB_LAV2_PO,
                        RG::RenderAlgorithm,
                        R::EnableIfGpuActive),
        ...
        FS_POPUP0(
            ...
            Radio(L"1x32 GPU - RC LAv2",
                  IDM_ALG_GPU_1_32_PERTURB_RC_LAV2,
                  RG::RenderAlgorithm,
                  R::EnableIfGpuActive),
            Radio(L"2x32 GPU - RC LAv2",
                  IDM_ALG_GPU_2_32_PERTURB_RC_LAV2,
                  RG::RenderAlgorithm,
                  R::EnableIfGpuActive),
            Radio(L"1x64 GPU - RC LAv2",
                  IDM_ALG_GPU_1_64_PERTURB_RC_LAV2,
                  RG::RenderAlgorithm,
                  R::EnableIfGpuActive),
            Radio(L"HDRx32 GPU - RC LAv2",
                  IDM_ALG_GPU_HDR_32_PERTURB_RC_LAV2,
                  RG::RenderAlgorithm,
                  R::EnableIfGpuActive),
            ...
            Radio(L"HDRx64 GPU - RC LAv2",
                  IDM_ALG_GPU_HDR_64_PERTURB_RC_LAV2,
                  RG::RenderAlgorithm,
                  R::EnableIfGpuActive),
        ...
        Radio(L"1x32 GPU - LAv2",
              IDM_ALG_GPU_1_32_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
        Radio(L"2x32 GPU - LAv2",
              IDM_ALG_GPU_2_32_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
        Radio(L"1x64 GPU - LAv2",
              IDM_ALG_GPU_1_64_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
        Radio(L"HDRx32 GPU - LAv2",
              IDM_ALG_GPU_HDR_32_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
        Radio(L"HDRx2x32 GPU - LAv2",
              IDM_ALG_GPU_HDR_2X32_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
        Radio(L"HDRx64 GPU - LAv2",
              IDM_ALG_GPU_HDR_64_PERTURB_LAV2,
              RG::RenderAlgorithm,
              R::EnableIfGpuActive),
