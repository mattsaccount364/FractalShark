...
quick_two_sum(float a, float b, float &err)
{
...
__host__ __device__ float
two_sum(float a, float b, float &err)
{
...
__host__ __device__ float
quick_two_diff(float a, float b, float &err)
{
    // if (a == b) {
    //	err = 0.0f;
    //	return 0.0f;
...
__host__ __device__ float
two_diff(float a, float b, float &err)
{
    // if (a == b) {
    //	err = 0.0f;
    //	return 0.0f;
...
split(float a, float &hi, float &lo)
{
...
/* Computes fl(a*b) and err(a*b). */
__device__ float
two_prod(float a, float b, float &err)
{
