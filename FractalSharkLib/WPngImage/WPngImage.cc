...
(int imageWidth, int imageHeight, int xOffset, int yOffset, PixelData_t pixel) {
    ...
    if (yOffset >= 0) { yBegin = 0; yEnd = absYOffset; } else { yBegin = imageHeight - absYOffset; yEnd = imageHeight; }
    if (xOffset >= 0) { xBegin = 0; xEnd = absXOffset; } else { xBegin = imageWidth - absXOffset; xEnd = imageWidth; }
