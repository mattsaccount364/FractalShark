...
TEST(MpirEval_ComplexAdd)
{
    ...
    mpf_set_d(a.z.re, 1.0);
    mpf_set_d(a.z.im, 2.0);
    mpf_set_d(b.z.re, 3.0);
    mpf_set_d(b.z.im, 4.0);
...
{
    ScopedMpfComplex a(256), b(256), out(256);
    mpf_set_d(a.z.re, 5.0);
    mpf_set_d(a.z.im, 7.0);
    mpf_set_d(b.z.re, 2.0);
    mpf_set_d(b.z.im, 3.0);
...
TEST(MpirEval_ComplexNorm)
{
    ...
    mpf_set_d(z.z.re, 3.0);
    mpf_set_d(z.z.im, 4.0);
...
TEST(MpirEval_ComplexSet)
{
    ...
    mpf_set_d(src.z.re, 1.5);
    mpf_set_d(src.z.im, -2.5);
