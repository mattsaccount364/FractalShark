...
public:
    ...
    CUDA_CRAP
    ATInfo(const ATInfo<IterType, T2, SubType2> &other)
        : StepLength(other.StepLength), ThresholdC(HDRFloat(other.ThresholdC)),
          SqrEscapeRadius(HDRFloat(other.SqrEscapeRadius)), RefC(HDRFloatComplex(other.RefC)),
          ZCoeff(HDRFloatComplex(other.ZCoeff)), CCoeff(HDRFloatComplex(other.CCoeff)),
          ...
          CCoeffNormSqr(HDRFloat(other.CCoeffNormSqr)), RefCNormSqr(HDRFloat(other.RefCNormSqr)),
...
public:
    ...
    Usable(HDRFloat SqrRadius)
    {
        ...
        if constexpr (IsHDR) {
            return result.compareToBothPositiveReduced(RefCNormSqr) > 0 &&
                   SqrEscapeRadius.compareToBothPositiveReduced(Four) > 0;
        } else {
            return result > RefCNormSqr && SqrEscapeRadius > 4;
        }
    }
...
ATInfo<IterType, HDRFloat, SubType>::ATInfo()
    : StepLength{}, ThresholdC{}, SqrEscapeRadius{}, RefC{}, ZCoeff{}, CCoeff{}, InvZCoeff{},
      CCoeffSqrInvZCoeff{}, CCoeffInvZCoeff{}, CCoeffNormSqr{}, RefCNormSqr{}
{
...
template <typename IterType, class HDRFloat, class SubType>
CUDA_CRAP bool
ATInfo<IterType, HDRFloat, SubType>::isValid(HDRFloatComplex DeltaSub0) const
{
    if constexpr (IsHDR) {
...
template <typename IterType, class HDRFloat, class SubType>
CUDA_CRAP ATInfo<IterType, HDRFloat, SubType>::HDRFloatComplex
ATInfo<IterType, HDRFloat, SubType>::getC(HDRFloatComplex dc) const
{
...
template <typename IterType, class HDRFloat, class SubType>
CUDA_CRAP ATInfo<IterType, HDRFloat, SubType>::HDRFloatComplex
ATInfo<IterType, HDRFloat, SubType>::getDZ(HDRFloatComplex z) const
{
