...
BenchmarkTimer &BenchmarkTimer::operator=(const BenchmarkTimer &other) {
    if (this != &other) {
        m_freq = other.m_freq;
        m_startTime = other.m_startTime;
        m_endTime = other.m_endTime;
...
BenchmarkTimer &BenchmarkTimer::operator=(BenchmarkTimer &&other) noexcept {
    if (this != &other) {
        m_freq = other.m_freq;
        m_startTime = other.m_startTime;
        m_endTime = other.m_endTime;
...
uint64_t BenchmarkTimer::GetDeltaInMs() const {
