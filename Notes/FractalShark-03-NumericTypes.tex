...
GPUs, where fp64 performance is \reviewme{perf}{often 32:1 slower than fp32}.
...
Because it uses only fp32 ALUs, \reviewme{perf}{it can, in principle, be faster than fp64-based alternatives
