...
perturbation; they evaluate the Mandelbrot iteration directly in the
...
\centering
\small
\caption[Mandelbrot base kernel variants]{Mandelbrot base kernel variants.}
...
\code{mandel\_2x\_double}
  & ${\sim}104$
  & \code{dbldbl} (\cref{subsec:ep-higher-prec}), a double-double expansion.
    Leading-component escape test for speed. \\[4pt]
...
\]
This test is fast but can misclassify points extremely near the boundary; a fully
...
\end{lstlisting}
This normalization keeps comparisons meaningful and stable in HDR arithmetic.
