...
Bilinear approximation, \reviewme{external}{introduced by Zhuoran in the Imagina
...
\reviewme{heuristic}{\code{LAThresholdScale} is an empirically chosen tunable parameter (default \(2^{-24}\)); no formal derivation is known}.
