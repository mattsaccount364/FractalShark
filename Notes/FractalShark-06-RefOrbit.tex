...
\reviewme{heuristic}{The code applies an empirically chosen radius-based heuristic (no formal derivation is known)}: let
...
by the factored form. \reviewme{rationale}{This choice simplifies reasoning about numerical behavior,
...
user-controlled tolerance.  Whenever the error exceeds the threshold, we emit a waypoint at \(n\)
...
\reviewme{perf}{multi-threaded reference-orbit computation typically outperforms the
