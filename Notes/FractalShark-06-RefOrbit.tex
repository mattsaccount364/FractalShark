...
extreme magnifications this means iterating
\begin{equation}
...
multi-threaded CPU, and GPU---and the storage and compression modes that
...
multi-threaded reference-orbit computation can outperform the
