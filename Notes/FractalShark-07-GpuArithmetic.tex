...
needed (\cref{fig:prefix-scan-comparison}). This propertyaligns well with the statistical structure of
...
This fusion eliminates one full random-accesspermutation pass over the
