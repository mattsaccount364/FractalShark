...
\end{equation}
Writing $d_n = d_x + i\,d_y$ for $\partial z_n/\partial c$ and
$e_n = e_x + i\,e_y$ for $\partial^2 z_n/\partial c^2$:
\begin{align}
e_{x,n+1} &= 2\,(d_x^2 - d_y^2) + 2\,(x_n\,e_x - y_n\,e_y), \\
e_{y,n+1} &= 2\,(2\,d_x\,d_y) + 2\,(x_n\,e_y + y_n\,e_x).
\end{align}
The first term is a complex squaring of $d_n$; the second is a complex product
$z_n \cdot e_n$.
