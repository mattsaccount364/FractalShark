...
Starting from \eqref{eq:ff-halley-decomp}, write the true second derivative as$F''$ and the 53-bit approximation as
...
implemented and dispatches through \code{DispatchNRByPrecision}
...
pipeline---antialiasing, colour mapping, and rendering orchestration---that
