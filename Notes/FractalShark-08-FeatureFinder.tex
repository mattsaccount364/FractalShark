...
\code{DispatchGpuNRByPrecision} rounds the coordinate precision to
...
implemented and dispatches through \code{DispatchGpuNRByPrecision}
in \code{FeatureFinder.cpp}.
