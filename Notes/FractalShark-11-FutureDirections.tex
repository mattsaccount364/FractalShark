...
\reviewme{external}{Descriptions of external algorithms in this chapter are based on cited sources and may not reflect the latest versions of those tools.}
