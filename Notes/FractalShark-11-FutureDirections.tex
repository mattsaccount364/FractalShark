...
The techniques described in this section are not implemented in
\FractalShark{} but represent important developments in the deep-zoom
Mandelbrot rendering community.  They are documented here for
completeness and to provide context for potential future work.  Each
subsection describes the technique, gives key formulas, and notes how it
relates to \FractalShark{}'s existing algorithms.
...
exceeded, the kernel simply falls back to perturbation for a few
...
$R = 4$ in the per-pixel kernels and $R = 256$ in the reference orbit),
...
require a histogram kernel but is architecturally straightforward.  The
