...
multithreaded MPIR backends and the manually selected CUDA implementation,
...
\begin{enumerate}
  ...
  \item Chooses an algorithm from \code{m\_Perturbation\-Alg}.  In
        ...
        selection does not choose the CUDA backend.  The manually selected
        \code{GPU} value dispatches to the CUDA implementation.
...
The production CPU paths use the expanded-product schedule.  The CUDA engine
