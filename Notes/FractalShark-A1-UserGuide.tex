...
\begin{itemize}
  ...
  \item \emph{Navigate} (submenu):
    \begin{itemize}
      ...
      \item \emph{Autozoom Filament Tip} (\code{s}) (command): Autozoom using the
...
\begin{itemize}
  \item \code{a}: Autozoom using the ``Feature'' heuristic.  Forces the
        ...
        target.
  \item \code{A} (\code{Shift+a}): Centre the view at the mouse cursor, then
  ...
  \item \code{s}: Autozoom using the ``FilamentTip'' heuristic.
\end{itemize}
