...
\begin{itemize}
  ...
  \item \textbf{High-precision arithmetic pipeline on GPU.}
  Includes a full multiply/add/subtract pipeline
  (\cref{sec:hp-add,sec:ntt-multiply}), a Number Theoretic Transform
  (NTT) implementation, parallel-prefix carry propagation, and
