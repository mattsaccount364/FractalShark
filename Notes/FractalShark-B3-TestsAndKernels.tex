...
\item \textbf{High-precision Ref1 kernels} (\cref{subsec:ref-orbit-gpu})
  \begin{itemize}
    \item \code{HpSharkReferenceGpuKernel}
    \item \code{HpSharkReferenceGpuLoop}
  \end{itemize}

\item \textbf{Fused high-precision Ref2 kernels}
  (\cref{subsec:fused-ntt-reference-step})
  \begin{itemize}
    \item \code{HpSharkReference2SetupKernel}
    \item \code{HpSharkReference2GpuLoop}
  \end{itemize}
