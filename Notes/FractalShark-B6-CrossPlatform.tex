...
historical primary development environment, but the native Linux GUI is expected
to reach feature parity with the Win32 GUI where platform capabilities allow.
Current gaps should be treated as Linux implementation status rather than as
intentional permanent divergence.
